  ...
  const header = `
        ...
        <ul class="rs-ul">
            ...
            <div class="navigation">
                <li class="rs-li"><a href="#" class="pointer">Словарь</a><img class="sort" src="./icons/sort.png"
                        alt="sort">
...
function setHeader() {
  ...
  localStorage.setItem('header', HEADER_NAVIGATION);
...
export {renderHeader, setHeader, getHeader};